...
public class HomeFragmentRecyclerViewAdapter extends RecyclerView.Adapter<HomeFragmentRecyclerViewAdapter.ViewHolder> {
     ...
     * by RecyclerView.
     */
    public HomeFragmentRecyclerViewAdapter(Context context, List<Item> dataSet) {
    ...
    public void onBindViewHolder(ViewHolder viewHolder, final int position) {
        ...
        if (item.getStatus().equals("finished")) { // don't show finished transactions
            return;
        }
        ...
        if (item.getClaimedBy() != null) { // draw claimed icon
        ...
        viewHolder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // launch new activity
                Intent intent = new Intent(context, ItemGiverDisplayActivity.class);
